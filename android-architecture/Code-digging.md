Going through the Android source code is so "exciting", but it is less so, when repeated. [AndroidXref](http://androidxref.com/) has been really instrumental in these endeavors.
